...
export const TRANSLATIONS = {
  en: {
    ...
    // Login & Sign Up
    tabExistingLogin: "📱 Existing Player: Login",
    tabNewSignUp: "✨ New Player: Sign Up",
    mobileNumber: "Mobile Number",
    tenDigits: "10 Digits",
    mobilePlaceholder: "e.g. 9876543210",
    loginMobileHint: "Enter your 10-digit number to restore your Nick Name, Coins & History",
    signupMobileHint: "Your mobile number is securely kept private. Only your Nick Name is shown in-game",
    fullName: "Full Name",
    required: "Required",
    optional: "Optional",
    fullNamePlaceholder: "e.g. Mahesh Reddy",
    nickName: "Nick Name",
    nickNamePlaceholder: "Leave blank for auto-initials (e.g. MR)",
    gameDisplayName: "Game Display Name",
    loginSubmitBtn: "🎮 Login to Bharakhatta",
    signUpSubmitBtn: "🚀 Sign Up & Claim 1,000 Coins",
    firstTimePrompt: "First time playing Bharakhatta?",
    signUpHere: "Sign Up here ➔",
    alreadyHaveAccount: "Already have an account?",
    loginHere: "Login with mobile ➔",
    errUnregistered: "Account not found with this mobile number. Please select 'Sign Up' to create your account!",
    errMissingName: "Please enter your Full Name to sign up.",
    ...
    menuFriendsSub: "4-Digit Table Code • Invite Friends",
    freeCoinsClaim: "CLAIM!",
    freeCoinsBtn: "Free 500🪙",
    store: "Store",
    inventory: "Inventory",
    home: "Home",
    club: "Club",
  ...
  te: {
    ...
    // Login & Sign Up (Telugu)
    tabExistingLogin: "📱 పాత ఆటగాడు: లాగిన్",
    tabNewSignUp: "✨ కొత్త ఆటగాడు: సైన్ అప్",
    mobileNumber: "మొబైల్ నంబర్",
    tenDigits: "10 అంకెలు",
    mobilePlaceholder: "ఉదా: 9876543210",
    loginMobileHint: "మీ ముద్దు పేరు, కాయిన్స్ & హిస్టరీ పొందడానికి 10 అంకెల నంబర్ నమోదు చేయండి",
    signupMobileHint: "మీ మొబైల్ నంబర్ గోప్యంగా ఉంటుంది. ఆటలో ముద్దు పేరు మాత్రమే కనిపిస్తుంది",
    fullName: "పూర్తి పేరు",
    required: "తప్పనిసరి",
    optional: "ఐచ్ఛికం",
    fullNamePlaceholder: "ఉదా: మహేష్ రెడ్డి",
    nickName: "ముద్దు పేరు",
    nickNamePlaceholder: "ఖాళీగా ఉంచితే మొదటి అక్షరాలు వస్తాయి (ఉదా: MR)",
    gameDisplayName: "ఆటలో కనిపించే పేరు",
    loginSubmitBtn: "🎮 బాఱఖట్టా లోకి లాగిన్ అవ్వండి",
    signUpSubmitBtn: "🚀 సైన్ అప్ చేసి 1,000 కాయిన్స్ పొందండి",
    firstTimePrompt: "మొదటిసారి బాఱఖట్టా ఆడుతున్నారా?",
    signUpHere: "ఇక్కడ సైన్ అప్ చేయండి ➔",
    alreadyHaveAccount: "ఇప్పటికే ఖాతా ఉందా?",
    loginHere: "మొబైల్‌తో లాగిన్ అవ్వండి ➔",
    errUnregistered: "ఈ మొబైల్ నంబర్‌తో ఖాతా లేదు. దయచేసి 'సైన్ అప్' ఎంచుకుని ఖాతాను నమోదు చేసుకోండి!",
    errMissingName: "సైన్ అప్ చేయడానికి దయచేసి మీ పూర్తి పేరు నమోదు చేయండి.",
    ...
    menuFriendsSub: "4 అంకెల కోడ్ • మిత్రులతో ఆడండి",
    freeCoinsClaim: "పొందండి!",
